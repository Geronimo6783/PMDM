...
class Actividad3(private var numeroCambios: Int, private var boton1: Button?, private var boton2: Button?, private var boton3: Button?) : AppCompatActivity() {
    ...
    private fun irAActividad1(view: View?){
        ...
        i.putExtra("Actividad Anterior", 3)
        startActivity(i)
    }
